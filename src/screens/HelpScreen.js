...
export default function HelpScreen() {
    ...
    <div className="my-5 text-center">
        ...
        <p>3. Select the Sepolia Test Network using Metamask 
            as the Dapp is currently deployed on Sepolia Test Network</p>
        ...
        <p>2. Fake ether
            can be used to add reviews. <a href="https://sepoliafaucet.com/">Click here</a> to get some ether for testing purposes.</p> 

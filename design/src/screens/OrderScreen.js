...
function OrderScreen({ match, history }) {
  ...
  //AdjWZAZbR6o7Hzfavf2MsLX3fxLiQjYVwoU3c-ssOHm3Zyn4U_l3dPhSsk4TrjWqaRHxZcQM1vWCA4Mi
  //AUB6_ADlaUqhenwHUK3iCDttRnINeXdagVcwe8_C5uQtrJkCYhEZ0nDhVXrdZxRMSHmvbAGDFDgUICmK
  const addPayPalScript = () => {
    const script = document.createElement("script");
    script.type = "text/javascript";
    script.src =
      "https://www.paypal.com/sdk/js?client-id=AUB6_ADlaUqhenwHUK3iCDttRnINeXdagVcwe8_C5uQtrJkCYhEZ0nDhVXrdZxRMSHmvbAGDFDgUICmK";
    script.async = true;
    script.onload = () => {
      setSdkReady(true);
    };
